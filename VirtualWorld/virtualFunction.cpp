...
Important: Irrespective of object is created or not, a static array of function pointer called VTABLE 
...
Compiler adds additional code at two places to maintain and use vptr.
	...
	2) wherever a polymorphic call is made, the compiler inserts code to first look for vptr. 
		Once vptr is fetched, vtable of derived class can be accessed. Using vtable, address of derived class function show() is accessed and called. 
